...
(function (canvas) {
    ...
    function pointOnHeart(t) {
        return new Point(
            200 * Math.pow(Math.sin(t), 3), // increase the coefficient from 160 to 200
            150 * Math.cos(t) - 75 * Math.cos(2 * t) - 30 * Math.cos(3 * t) - 15 * Math.cos(4 * t) + 37.5 // increase the coefficient from 130 to 150
        );
    }
